...
import { TaskTypesEnum, UserTask } from "@common/constants/types";
import TaskCard, { TaskTypes } from "./TaskCard/TaskCard";
import _ from "lodash";
import AppSteps from "@app/common/components/ui/AppSteps";
...
export default function PracticeComponent({ isAlphabet, tasks, taskTypes, onCheckReaded, renderFooter, onLastStep }: Props) {
    ...
    return <>
        ...
        <div className="mb-3">
            {currentTask &&
                <TaskCard id={currentTask.id} tasks={tasks} key={currentTask.id} checkReaded={checkReaded} forcedTaskTypes={taskTypes} />
            }
        </div>
